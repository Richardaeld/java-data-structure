...
//        System.out.println("live");
        ...
        Graph<String> graph = new UnweightedGraphWithNorecursiveDFS<>(vertices, edges);
        ...
        for (int i = 0; i < searchOrders.size(); i++)
            if (dfs.getParent(i) != -1) System.out.println("parent of " + graph.getVertex(i) + " is " + graph.getVertex(dfs.getParent(i)));
    }
}
...
//    ===================================================================
//    START CLASS WORK 1 of 2
//    ===================================================================


class UnweightedGraphWithNorecursiveDFS<V> extends UnweightedGraph<V> {
    public UnweightedGraphWithNorecursiveDFS(V[] vertices, int[][] edges) {
        super(vertices, edges);
    }
}

//    ===================================================================
//    END CLASS WORK 1 of 2
//    ===================================================================
...
//    ===================================================================
    ...
    public Tree dfs(int v) {
        ...
        for (int i = 0; i < vertices.size(); i++) {
//            Add Vertex to search order and visited array/arraylist
            searchOrder.add(v);
            isVisited[v] = true; // Vertex v visited
//            Iterate over all edges of vertex v
            for (Edge e : neighbors.get(v)) {
                if (!isVisited[e.v]) {
//                    Add vertex to parent list and update to newest vertex
                    parent[e.v] = v; // The parent of vertex e.v is u
                    v = e.v;
                    break;
                }
            }
